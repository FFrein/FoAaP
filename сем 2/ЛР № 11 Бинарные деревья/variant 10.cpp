//Дан указатель p1 на корень непустого дерева. Написать функцию вывода суммы значений всех вершин данного дерева ( 10 варик )
...
int sum2 = 0;
void sum(Tree* t, int level) //задание
{
	int sum1;
	if (t)
	{
